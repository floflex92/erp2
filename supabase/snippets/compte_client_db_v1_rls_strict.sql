...
-- Usage: a executer apres foundation + bootstrap
-- Principe:
-- 1) deny by default (RLS active)
-- 2) autoriser uniquement les lignes du compte actif
-- 3) compte actif porte par la variable de session app.current_compte_erp_id
...
-- ============================================================
-- Drop legacy policies for these tables (if any)
-- ============================================================
...
-- Append-only: insert autorise, update/delete refuses implicitement (pas de policy)
