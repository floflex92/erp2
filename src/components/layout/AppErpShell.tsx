/**
 * AppErpShell — charge AuthProvider (et donc vendor-supabase) en lazy.
 * Ce composant n'est jamais importé statiquement depuis App.tsx,
 * ce qui garantit que vendor-supabase ne fait PAS partie du bundle
 * critique chargé sur les pages marketing (/, /fonctionnalites, etc.).
 *
 * Il est activé uniquement lorsque l'utilisateur navigue vers une route ERP
 * (/login, /dashboard, /planning, etc.).
 */
...
// ─── Helpers (nécessitent AuthProvider) ───────────────────────────────────
...
// ─── Shell ERP (enveloppé dans AuthProvider) ───────────────────────────────
