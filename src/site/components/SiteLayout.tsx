...
export default function SiteLayout() {
  ...
  const isDarkBg = isScrolled || hasDarkHero
  const navTextColor = isDarkBg ? '#FFFFFF' : '#1B1B1B'
  ...
  return (
    <div className="site-shell min-h-screen">
      ...
      <footer style={{ background: 'var(--site-bg-alt)', paddingInline: 'clamp(24px, 8vw, 160px)', paddingBlock: '64px 40px' }}>
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <img
              ...
              decoding="async"
            />
            <p className="mt-3 max-w-md text-sm leading-7" style={{ color: 'var(--site-text-secondary)' }}>
          ...
          <div className="grid gap-8 text-sm sm:grid-cols-2 sm:gap-10 lg:grid-cols-5 lg:gap-12" style={{ color: 'var(--site-text-secondary)' }}>
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em]" style={{ color: 'var(--site-text-discreet)' }}>Produit</p>
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em]" style={{ color: 'var(--site-text-discreet)' }}>Entreprise</p>
              <div className="mt-3 grid gap-2.5">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em]" style={{ color: 'var(--site-text-discreet)' }}>Légal</p>
              <div className="mt-3 grid gap-2.5">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.12em]" style={{ color: 'var(--site-text-discreet)' }}>Partenaires</p>
              <div className="mt-3 grid gap-2.5">
                <a
        ...
        <div className="mt-10 flex items-center justify-between">
          <p className="text-xs" style={{ color: 'var(--site-text-discreet)' }}>© 2026 NEXORA Truck — Tous droits réservés</p>
        ...
        <p className="mt-6 max-w-5xl text-xs leading-6" style={{ color: 'var(--site-text-secondary)' }}>
