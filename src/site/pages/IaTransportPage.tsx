...
const problems = [
  ...
  'Chaque tournée optimisée a la main laisse en moyenne 18 % de kilométrage a vide évitable sur la journée.',
...
const solutionPillars = [
  ...
  },
  {
    ...
    body: 'Identification automatique des courses partageant une zone ou un itinéraire pour réduire le kilométrage a vide sans effort de planification supplémentaire.',
  },
  {
...
const keyFeatures = [
  ...
  { title: 'Prédiction de retard avant départ', body: 'Analyse des conditions, créneaux et historiques pour signaler les missions   risque et prévenir les clients.' },
...
export default function IaTransportPage() {
  useSiteMeta({
    ...
    description:
      'IA transport NEXORA Truck : suggestions d’affectation en 1 clic, détection de retard avant départ, optimisation km   vide et alerte marge en dérive en temps réel.',
  ...
  return (
    <div className="space-y-8">
      ...
      <SiteSection eyebrow="Problèmes" title="Ce que l'exploitation gagne   automatiser" description="L'IA intervient l  où la charge cognitive et les données non connectées ralentissent les décisions.">
      ...
      <SiteSection eyebrow="Solution NEXORA" title="Une IA au service de l'exploitant, pas   sa place" description="NEXORA Truck utilise l'IA pour assister la décision, pas pour la remplacer.">
      ...
      <SiteSection eyebrow="Intégration" title="Comment NEXORA connecte ERP, TMS et IA" description="L'IA n'a de valeur que si elle est connectée aux données opérationnelles réelles.">
        <div className="space-y-4 text-sm leading-7 text-[var(--site-text-secondary)] sm:text-base">
          ...
          <p>
            ...
            position GPS, vitesse, arrêts et écarts de trajet sont analysés en continu pour identifier les missions   risque
            avant qu&apos;elles ne génèrent un retard client ou un coût supplémentaire.
          </p>
          <p>
            L&apos;optimisation kilométrique réduit les courses   vide en regroupant intelligemment les missions selon les zones de
            livraison et les retours disponibles. Cette fonctionnalité est directement reliée   la{' '}
      ...
      <SiteSection eyebrow="En savoir plus" title="Pages complémentaires" description="Approfondir les sujets reliés   l'intelligence artificielle dans le transport." muted>
