...
export const ROLE_ACCESS: Record<Role, string[]> = {
  ...
  conducteur: ['dashboard-conducteur', 'planning', 'tasks', 'feuille-route', 'terrain', 'frais', 'frais-rapide', 'tachygraphe', 'amendes', 'planning-conducteur', 'parametres', 'communication', 'tchat', 'mail', 'coffre', 'mentions-legales', 'formulaires-terrain'],
  conducteur_affreteur: ['dashboard-conducteur', 'planning', 'tasks', 'feuille-route', 'terrain', 'frais', 'frais-rapide', 'tachygraphe', 'amendes', 'planning-conducteur', 'parametres', 'communication', 'tchat', 'mail', 'coffre', 'mentions-legales'],
  ...
  logisticien: ['dashboard', 'ops-center', 'alertes', 'tasks', 'entrepots', 'transports', 'planning', 'map-live', 'terrain', 'communication', 'inter-erp', 'tchat', 'mail', 'coffre', 'mentions-legales', 'optimisation-tournees', 'messagerie-colis', 'formulaires-terrain', 'gestion-temperature'],
}
