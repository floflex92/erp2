...
export const ROLE_ACCESS: Record<Role, string[]> = {
  ...
  exploitant: ['dashboard', 'ops-center', 'alertes', 'tasks', 'chauffeurs', 'rh', 'entretiens-salaries', 'vehicules', 'remorques', 'equipements', 'maintenance', 'transports', 'entrepots', 'clients', 'facturation', 'reglements', 'analytique-transport', 'bilan-co2', 'compte-client-db', 'espace-client', 'espace-affreteur', 'frais', 'tachygraphe', 'amendes', 'map-live', 'planning', 'feuille-route', 'demandes-clients', 'parametres', 'communication', 'inter-erp', 'tchat', 'mail', 'coffre', 'mentions-legales', 'optimisation-tournees', 'messagerie-colis', 'formulaires-terrain', 'gestion-temperature'],
  ...
  conducteur: ['dashboard-conducteur', 'tasks', 'feuille-route', 'frais', 'frais-rapide', 'tachygraphe', 'amendes', 'planning-conducteur', 'parametres', 'communication', 'tchat', 'mail', 'coffre', 'mentions-legales', 'formulaires-terrain'],
  ...
  investisseur: ['dashboard', 'transports', 'clients', 'facturation', 'communication', 'inter-erp', 'coffre', 'mentions-legales', 'analytique-transport', 'bilan-co2'],
  logisticien: ['dashboard', 'ops-center', 'alertes', 'tasks', 'entrepots', 'transports', 'planning', 'map-live', 'communication', 'inter-erp', 'tchat', 'mail', 'coffre', 'mentions-legales', 'optimisation-tournees', 'messagerie-colis', 'formulaires-terrain', 'gestion-temperature'],
}
